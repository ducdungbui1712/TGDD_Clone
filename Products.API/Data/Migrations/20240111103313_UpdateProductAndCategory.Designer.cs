...
namespace Products.API.Data.Migrations
{
    ...
    [Migration("20240111103313_UpdateProductAndCategory")]
            ...
            modelBuilder.Entity("Products.API.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            Color = "Blue Titanium",
                            CreatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1605),
                            ...
                            ProductLine = "iPhone",
                            UpdatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1622)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            CreatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1625),
                            Description = "Latest iPhone model",
                            ...
                            ProductLine = "iPhone",
                            UpdatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1626)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            CreatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1629),
                            Description = "Latest iPhone model",
                            ...
                            ProductLine = "iPhone",
                            UpdatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1629)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            CategoryId = 1,
                            Color = "Yellow",
                            CreatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1631),
                            Description = "Latest iPhone model",
                            ...
                            ProductLine = "iPhone",
                            UpdatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1632)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            CategoryId = 2,
                            Color = "Midnight",
                            CreatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1634),
                            ...
                            ProductLine = "MacBook",
                            UpdatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1635)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            CategoryId = 2,
                            Color = "Silver",
                            CreatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1637),
                            Description = "The latest MacBook model",
                            ...
                            ProductLine = "MacBook",
                            UpdatedAt = new DateTime(2024, 1, 11, 17, 33, 12, 395, DateTimeKind.Local).AddTicks(1638)
                        });
                });
